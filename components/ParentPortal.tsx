    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center">
        <div>
           ...
           <p className="text-slate-500">Overview for {CURRENT_PARENT_NAME}</p>
        </div>
      </div>
        ...
        {myChildren.map(child => {
           ...
           return (
             <div 
               ...
               className={`relative min-w-[300px] cursor-pointer rounded-2xl p-5 border-2 transition-all duration-300 group overflow-hidden ${
                 isSelected 
                ...
                <div className="flex items-center gap-4">
                   <div className="relative">
                       <img 
                         ...
                         alt={child.name} 
                         className={`w-16 h-16 rounded-full object-cover border-4 transition-colors ${isSelected ? 'border-indigo-50' : 'border-slate-50'}`} 
                       />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                 ...
                 <Card className="bg-amber-50 border-amber-100 hover:shadow-md transition-shadow">
                    <div className="flex flex-col">
                       ...
                       <span className="text-2xl font-bold text-slate-800">${totalDue}</span>
